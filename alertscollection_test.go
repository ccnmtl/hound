...
func (d DummyEmailer) Throttled(failures, global_throttle int, emailTo string)                {}
func (d DummyEmailer) RecoveryThrottled(recoveries_sent, global_throttle int, emailTo string) {}
